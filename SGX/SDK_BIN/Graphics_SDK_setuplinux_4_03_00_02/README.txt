...
This release includes the Linux graphics drivers for the 387x/389x/OMAP35x/AM35x/37xx family of chipsets. The 
Graphics SDK contains documentation, demo programs and tools. 
...
• [NEW] Included pvr2d.h and wsegl.h in the release package under include folder of Graphics SDK root 
installtion(public versions – with public headers: (MIT-x license)). Qt users should use the included wsegl.h and 
pvr2d.h 
• [NEW] Included bc_cat.h(with BSD license)in the release package for applications which require to use buffer 
class streaming extension. 
• [NEW] Unit test report for 387x and 389x is now available in the release package(can be found under unittest 
folder present at Graphics installation root directory with file name : 
Graphics_SDK_4_03_00_02_38xx_Test_report.xls) 
• Bug fixes 
Pre-requisites 
...
Need to rebuild proc manager app - procmgrapp_release, not the one 
present under the HDVPSS_01_00_01_26 release (procmgrapp) 
...
• [SDOCM00079464] : Crash observed when get_clk() returns error by passing an invalid SGX clock name in IMG 
code 
...
RN 4 03 00 02 Source: http://processors.wiki.ti.com/index.php?oldid=53557 Contributors: Mahesh 
