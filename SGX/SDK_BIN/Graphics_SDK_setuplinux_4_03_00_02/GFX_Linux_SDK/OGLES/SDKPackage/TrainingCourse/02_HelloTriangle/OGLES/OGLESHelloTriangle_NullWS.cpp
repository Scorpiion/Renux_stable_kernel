/******************************************************************************
 ...
 @File         OGLESHelloTriangle_NullWS.cpp
...
int main(int argc, char **argv)
{
	...
	*/
	...
	// We're going to draw a triangle to the screen so create a vertex buffer object for our triangle
	{
		...
		unsigned int uiSize = 3 * (sizeof(VERTTYPE) * 7); // Calc afVertices size (3 vertices * stride (7 verttypes per vertex (3 pos + 4 color)))
...
/******************************************************************************
 End of file (OGLESHelloTriangle_NullWS.cpp)
******************************************************************************/
