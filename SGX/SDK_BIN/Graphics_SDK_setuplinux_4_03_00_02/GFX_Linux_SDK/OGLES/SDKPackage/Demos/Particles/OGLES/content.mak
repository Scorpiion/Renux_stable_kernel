...
LightTex.pvr: $(MEDIAPATH)/LightTex.png
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/LightTex.png -o$@

FloorTex8.pvr: $(MEDIAPATH)/FloorTex8.png
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/FloorTex8.png -o$@
